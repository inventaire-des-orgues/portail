...
class Orgue(models.Model):
    ...
    qualification_palissy = models.CharField(max_length=24, null=True, choices=CHOIX_QUALIFICATION_PALISSY,
                                             verbose_name="Dénomination dans Palissy", blank=True, help_text="Si inscrit ou classé, qualification de l'orgue, dans Palissy")
    ...
    lien_inventaire_regions = models.CharField(verbose_name="Référence(s) IM de l'inventaire régional", max_length=60, null=True, blank=True)
    ...
    commentaire_admin = models.TextField(verbose_name="Commentaire contributeurs", null=True, blank=True,
                                         help_text="Commentaire uniquement visible par les contributeurs, par exemple pour indiquer un doute ou point à creuser. Inutile de mentionner la date de contribution déjà enregistrée par ailleurs. Pour contacter les administrateurs, rédigez un courriel.")
...
class Clavier(models.Model):
    ...
    type = models.ForeignKey(TypeClavier, verbose_name="Nom", null=True, on_delete=models.CASCADE, db_index=True,
                             help_text="Pensez à utiliser le clavier... d'ordinateur pour compléter aisément les longs formulaires : [Tab]: avancer, [Maj+Tab] : reculer, [Espace] : dérouler, [Haut/Bas] : choisir.")
