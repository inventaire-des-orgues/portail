                    ...
                    if facteur_delete.count() == 0:
                        ...
                        for f in range(1, len(couple_facteur)):
                            ...
                            if manufacture_replace.count() == 0:
                                erreur = True
                                print("ERROR : Le nom de la manufacture qui doit prendre place n'existe pas : {}".format(manufacture_apres))
                            elif manufacture_replace.count() > 1:
                                erreur = True
                                print("ERROR : Deux manufactures à mettre portent le même nom : {}".format(manufacture_apres))
                        if not erreur:
                            print("INFO : Je cherche à remplacer {} par {}".format(facteur_delete, liste_manufacture_apres))
