...
import orgues.management.utilsorgues.tools.generiques as gen


loggerCorrecteurorgues = logging.getLogger('correcteurogues')
loggerCorrecteurorgues.setLevel(logging.DEBUG)
# create file handler which logs even debug messages
fhc = logging.FileHandler('./orgues/management/utilsorgues/logs/inventaire--correcteurorgues.log')
