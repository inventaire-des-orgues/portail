...
urlpatterns = [
    ...
    path('liste.json2', v.OrgueListJS2.as_view(), name='orgue-list-js2'),
    path('orgueinformation.json', v.OrgueInformations.as_view(), name='orgue-informations'),
    path('stats.json', v.Stats.as_view(), name='orgue-stats-js'),
    path('carte/', v.OrgueCarte.as_view(), name='orgue-carte'),
    path('carte2/', v.OrgueCarte2.as_view(), name='orgue-carte2'),
